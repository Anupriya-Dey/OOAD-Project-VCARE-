...
class _prescriptionState extends State<prescription> {
  List<prescriptionText> pres = [
    prescriptionText.constructor1(
        Doctor.constructor2("Dr Shalini veda", "234567", "psychiatrist","kgupta@gmail.com","MBBS, AIIMS Rishikesh"),
        Text("Cugh Syrup before lunch/dinner")),
    prescriptionText.constructor1(
        Doctor.constructor2("Dr Shalini veda", "234567", "psychiatrist","kgupta@gmail.com","MBBS, AIIMS Rishikesh"),
        Text("Paracatemol after breakfast/lunch/dinner")),
    prescriptionText.constructor1(
        Doctor.constructor2("Dr Vedik gosh", "2345622", "General practitioner","kgupta@gmail.com","MBBS, AIIMS Rishikesh"),
